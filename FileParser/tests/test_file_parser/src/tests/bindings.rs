...
pub type std_list_size_type = std_size_t;
...
fn bindgen_test_layout_std___detail__List_node_base() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<std___detail__List_node_base>()))._M_next as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<std___detail__List_node_base>()))._M_prev as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_std___detail__List_node_header() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<std___detail__List_node_header>()))._M_size as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
...
#[repr(C)]
pub struct IHandler__bindgen_vtable(::std::os::raw::c_void);
#[repr(C)]
#[derive(Debug)]
pub struct IHandler {
    pub vtable_: *const IHandler__bindgen_vtable,
}
#[test]
fn bindgen_test_layout_IHandler() {
    assert_eq!(
        ::std::mem::size_of::<IHandler>(),
        8usize,
        concat!("Size of: ", stringify!(IHandler))
    );
    assert_eq!(
        ::std::mem::align_of::<IHandler>(),
        8usize,
        concat!("Alignment of ", stringify!(IHandler))
    );
}
extern "C" {
    #[link_name = "\u{1}_ZN8IHandlerC2Ev"]
    pub fn IHandler_IHandler(this: *mut IHandler);
}
impl IHandler {
    #[inline]
    pub unsafe fn new() -> Self {
        let mut __bindgen_tmp = ::std::mem::MaybeUninit::uninit();
        IHandler_IHandler(__bindgen_tmp.as_mut_ptr());
        __bindgen_tmp.assume_init()
    }
}
extern "C" {
    #[link_name = "\u{1}_ZN8IHandlerD1Ev"]
    pub fn IHandler_IHandler_destructor(this: *mut IHandler);
}
#[repr(C)]
pub struct Pipeline__bindgen_vtable(::std::os::raw::c_void);
#[repr(C)]
pub struct Pipeline {
    pub vtable_: *const Pipeline__bindgen_vtable,
    pub m_handlers: std_list,
}
#[test]
fn bindgen_test_layout_Pipeline() {
    assert_eq!(
        ::std::mem::size_of::<Pipeline>(),
        32usize,
        concat!("Size of: ", stringify!(Pipeline))
    );
    assert_eq!(
        ::std::mem::align_of::<Pipeline>(),
        8usize,
        concat!("Alignment of ", stringify!(Pipeline))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Pipeline>())).m_handlers as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(Pipeline),
            "::",
            stringify!(m_handlers)
        )
    );
}
extern "C" {
    #[link_name = "\u{1}_ZNK8Pipeline6HandleERSi"]
    pub fn Pipeline_Handle(this: *const Pipeline, stream: *mut std_istream);
}
extern "C" {
    #[link_name = "\u{1}_ZN8Pipeline11PushHandlerESt10shared_ptrI8IHandlerE"]
    pub fn Pipeline_PushHandler(this: *mut Pipeline, handler: std_shared_ptr);
}
extern "C" {
    #[link_name = "\u{1}_ZNK8Pipeline6ReportERSo"]
    pub fn Pipeline_Report(this: *const Pipeline, stream: *mut std_ostream);
}
extern "C" {
    #[link_name = "\u{1}_ZNK8Pipeline13BuildSuccededEv"]
    pub fn Pipeline_BuildSucceded(this: *const Pipeline) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZNK8Pipeline5ErrorB5cxx11Ev"]
    pub fn Pipeline_Error(this: *const Pipeline) -> std_string;
}
extern "C" {
    #[link_name = "\u{1}_ZN8Pipeline12BuildCounterERS_PcS1_"]
    pub fn Pipeline_BuildCounter(
        arg1: *mut Pipeline,
...
extern "C" {
    #[link_name = "\u{1}_ZN8Pipeline13BuildReplacerERS_PcS1_S1_"]
    pub fn Pipeline_BuildReplacer(
        arg1: *mut Pipeline,
        arg2: *mut ::std::os::raw::c_char,
        arg3: *mut ::std::os::raw::c_char,
...
impl Pipeline {
    #[inline]
    pub unsafe fn Handle(&self, stream: *mut std_istream) {
        Pipeline_Handle(self, stream)
    }
    #[inline]
    pub unsafe fn PushHandler(&mut self, handler: std_shared_ptr) {
        Pipeline_PushHandler(self, handler)
    }
    #[inline]
    pub unsafe fn Report(&self, stream: *mut std_ostream) {
        Pipeline_Report(self, stream)
    }
    #[inline]
    pub unsafe fn BuildSucceded(&self) -> bool {
        Pipeline_BuildSucceded(self)
    }
    #[inline]
    pub unsafe fn Error(&self) -> std_string {
        Pipeline_Error(self)
    }
    #[inline]
    pub unsafe fn BuildCounter(
        arg1: *mut Pipeline,
        arg2: *mut ::std::os::raw::c_char,
        arg3: *mut ::std::os::raw::c_char,
    ) {
        Pipeline_BuildCounter(arg1, arg2, arg3)
    }
    #[inline]
    pub unsafe fn BuildReplacer(
        arg1: *mut Pipeline,
        arg2: *mut ::std::os::raw::c_char,
        arg3: *mut ::std::os::raw::c_char,
        arg4: *mut ::std::os::raw::c_char,
    ) {
        Pipeline_BuildReplacer(arg1, arg2, arg3, arg4)
    }
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[test]
fn __bindgen_test_layout_std_list_open0_std_shared_ptr_open1_IHandler_close1_std_allocator_open1_std_shared_ptr_open2_IHandler_close2_close1_close0_instantiation(
) {
    assert_eq!(
        ::std::mem::size_of::<std_list>(),
        24usize,
        concat!("Size of template specialization: ", stringify!(std_list))
    );
    assert_eq!(
        ::std::mem::align_of::<std_list>(),
        8usize,
        concat!(
            "Alignment of template specialization: ",
            stringify!(std_list)
...
#[test]
fn __bindgen_test_layout_std_allocator_open0_std_shared_ptr_open1_IHandler_close1_close0_instantiation(
) {
    assert_eq!(
        ::std::mem::size_of::<std_allocator>(),
        1usize,
